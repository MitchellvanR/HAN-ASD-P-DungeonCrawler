...
@DisplayName("Tests for MoveRightCommand")
class MoveRightCommandTest {

  private Game gameMock;
  private MoveRightCommand sut;
  ...
  public void beforeEach() {
    ...
    sut = new MoveRightCommand(gameMock);
  ...
  @Test
  @DisplayName("perform1_check if player moves one tile to the right")
  void perform1() {
    /*Arrange*/
    var expected = 100;
