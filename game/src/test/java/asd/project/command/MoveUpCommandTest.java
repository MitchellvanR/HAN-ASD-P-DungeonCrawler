...
@DisplayName("Tests for MoveUpCommand")
class MoveUpCommandTest {

  private MoveUpCommand sut;
  ...
  void beforeEach() {
    ...
    sut = new MoveUpCommand(gameMock);
  }

  @Test
  @DisplayName("perform1_test whether move up command triggers expected y to be 1 lower")
  void perform1() {
    // Arrange
    int initialY = 100;
    int expectedY = 99;
